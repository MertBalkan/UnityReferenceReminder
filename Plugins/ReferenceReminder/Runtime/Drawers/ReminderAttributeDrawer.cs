...
[CustomPropertyDrawer(typeof(ReminderAttribute))]
public class ReminderAttributeDrawer : PropertyDrawer
{
    ...
    {
        ReminderAttribute reminderAttribute = (ReminderAttribute) attribute;
        ...
        if (IsRefNull(property))
        {
            ...
            EditorGUI.HelpBox(helpBoxRect, $"{label.text} ({reminderAttribute.reminderText})", MessageType.Warning);
